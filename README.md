...
### meter node
Use the `pac2200`, `xxxx` or `xxx` node to configure which information you want to request from the device.

Wire the output of the `pac2200`, `xxx` or `xxx` to the input of the `Modbus Flex Getter` from 'node-red-contrib-modbus' modules.
